												...
												<div class="flex items">
													...
													<div class="ml-4">
														...
														<div class="text-sm text-gray-500">
															{{ formatDateandTime(journey.departure) }}
														</div>
													</div>
...
const journeys = computed(() => store.getters.journey);
...
const nextPage = () => {
	...
	page.value++;
	store.dispatch("getjourney", page.value);
...
const formatDateandTime = (date) => {
	...
	//   add pm and am and day  and month in words
	if (hour > 12) {
		return `${day}/${month}/${year} ${hour - 12}:${minute}:${second} pm`;
	} else {
		return `${day}/${month}/${year} ${hour}:${minute}:${second} am`;
	}
